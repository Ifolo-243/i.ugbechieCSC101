...
fn main() {
    ...
    if job_title == "office administrator" {
        ...
        println!("Your choice is unavailable");
    }

}

fn off_admin() {
    println!("These are the job levels. Please enter yours");
    println!("intern");
    ...
    println!("Director");
    println!("CEO");
    let _job_level_for_off_admin = vec!["intern","administrator","senior administrator","office manager","Director","CEO"];
    ...
    let public_servant = vec!["APS 1-2", "APS 3-5","APS 5-8","APS 8-10","APS 10-13","SES"];
    if job_level == "intern"{
        println!(" the position is yours: {}",public_servant[0] );
    }else if job_level == "administrator"{
        println!("the position is yours: {}",public_servant[1]);
    }else if job_level == "senior administrator"{
        println!("the position is yours: {}", public_servant[2]);
    }else if job_level == "office manager"{
        println!("the position is yours: {}",public_servant[3] );
    }else if job_level == "director"{
        println!("the position is yours: {}",public_servant[4] );
    }else if job_level == "ceo"{
        println!("the position is yours: {}",public_servant[5] );
    }else{
...
fn academic() {
    println!("These are the different job levels. Please input yours:");
